...
function addFigure(radius, center, color) {
  objects.push(new sphere(radius, createVector(center[0],center[1], center[2]), createVector(color[0], color[1], color[2])));
}
...
$(document).ready(function(){
  ...
  $("#addFigure").click(function(){
    console.info('add figure');
    valueRadius = parseInt($("#radio").val());
    valueCenter = $("#center").val().split(",");
    valueColor = $("#color").val().split(",");
    addFigure(valueRadius, valueCenter, valueColor);
